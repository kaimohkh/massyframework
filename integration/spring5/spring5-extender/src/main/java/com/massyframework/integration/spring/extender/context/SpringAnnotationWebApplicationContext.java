 ...
 * @author huangkaihui
 */
public class SpringAnnotationWebApplicationContext extends AnnotationConfigWebApplicationContext {
	 ...
	 * 
	 */
	public SpringAnnotationWebApplicationContext(BeanDefiner beanDefiner) {
